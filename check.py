...
def cnv():
    python3_command = "python try_1.py"  # launch your python3 script using bash
...
def play():
    os.system("vlc audio-file.mp3")
    sys.exit(0)


def save():
    python3_command = "python try_3.py"  # launch your python3 script using bash
...
def main():
    ...
    a1 = tkinter.Label(window, text="Automated Audio Book Reader", fg="#383a39", bg="#fff",
                       font=("Helvetica", 22))
    ...
    # pack the widget into the window
    b4.pack()
    bottomLabel = tkinter.Label(window, text="Created by girlCoder8")
